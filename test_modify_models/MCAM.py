...
if __name__ == '__main__':
    model = SHSA_NET()
    input_tensor_1 = torch.randn(1, 3, 224, 224)  # 示例输入，假设为224x224的RGB图像
    input_tensor_2 = torch.randn(1, 3, 224, 224)  # 示例输入，假设为224x224的RGB图像
    block = MCAM(in_channels=960)

    o1 = model(input_tensor_1)
    o2 = model(input_tensor_2)
